...
exports.handleCalendar = handleCalendar;
...
async function handleCalendar(businessId, message, intent) {
    // Get Google tokens
...
async function queryCalendar(calendar, message) {
...
async function addCalendarEvent(calendar, businessId, message) {
